class PromotionalRules
  PROMOTIONS = [
                ...
                :lavender_cinnamon_shampoo_promotion,
  ...
  def lavender_cinnamon_shampoo_promotion total, basket
    if two_or_more_lavender_hearts?(basket) && cinnamon_shampoo?(basket)
      total = total - total/5
    end
    total
  end

  def cinnamon_shampoo? basket
    basket.include? 004
  end
